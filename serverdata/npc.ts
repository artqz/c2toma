    ...
    Array.from(npcdata)
      .filter(
        (npc) =>
          ...
          getId({ npcName: slug(npc.$[2], "_"), npcNewIdByName })
      )
      .map((npc): Npc => {
        ...
        const id = getId({ npcName, npcNewIdByName });
        const { name, nick } = npcNameById.get(oldId) ?? { name: npcName };
            ...
            collision: {
              radius: {
                $: {
                  ...
                  ...(npc.collision_radius.$[0] !==
                    npc.collision_radius.$[1] && {
              ...
              height: {
                $: {
                  ...
                  ...(npc.collision_height.$[0] !==
                    npc.collision_height.$[1] && {

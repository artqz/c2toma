...
export function loadQuestNamesGF(): QuestNameEntryGF[] {
  ...
  return data.map((x) => {
    const questName: QuestNameEntryGF =  {
      ...
      tabs1: pushItems({0: x['items[0]'], 1: x['items[1]'], 2:x['items[2]'], 3:x['items[3]'], 4:x['items[4]'], 5:x['items[5]'], 6:x['items[6]'], 7:x['items[7]'], 8:x['items[8]'], 9:x['items[9]'], 10:x['items[10]']}),
      tabs2: pushItems({0: x['num_items[0]'], 1: x['num_items[1]'], 2:x['num_items[2]'], 3:x['num_items[3]'], 4:x['num_items[4]'], 5:x['num_items[5]'], 6:x['num_items[6]'], 7:x['num_items[7]'], 8:x['num_items[8]'], 9:x['num_items[9]'], 10:x['num_items[10]']}),
    };
